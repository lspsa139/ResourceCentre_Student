...
public class ResourceCentreTest {
	...
	public void testRetrieveAllCamcorder() {
		...
		//test if the list of camcorders retrieved from the ResourceCentre is empty
	...
	public void testRetrieveAllChromebook() {
		...
		//test if the list of Chrome book retrieved from the ResourceCentre is empty
		...
		//test if the expected output string same as the list of chrome book retrieved from the SourceCentre
	...
	public void testDoLoanCamcorder() {
		...
		//boundary // Test that there is a valid (non-empty) array list of camcorder for loan
		...
		//error condition  // Loan an item again
		...
		//error condition  // Loan a non-existing item
	...
	public void testDoLoanChromebook() {
		//fail("Not yet implemented");
		// write your code here
		//boundary // Test that there is a valid (non-empty) array list of chromebook for loan
